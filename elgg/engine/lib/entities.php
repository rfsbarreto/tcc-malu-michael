 ...
 */
 function elgg_list_entities(array $options = array(), $getter = 'elgg_get_entities',
	...
	$options['count'] = $count;
	//echo $entities[1]->description;
	return $viewer($entities, $options);
}

/**
* Retorna a entidade uma view.
* O retorno desta fun\E7\E3o possui os atributos title, description do objetoElgg
* Altera\E7\E3o feita por Michael e Malu
* Data de altera\E7\E3o 27/03/2013
*/

function elgg_list_entities_atributos(array $options = array(), $getter = 'elgg_get_entities',
$viewer = 'elgg_view_entity_list_rota')
{
	global $autofeed;
	$autofeed = true;
