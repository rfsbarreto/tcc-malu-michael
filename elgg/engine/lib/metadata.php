...
* Objetivo retornar uma lista de entidades
*/

function elgg_list_entites_from_metadata_rotaSearch($options)
{	
	return elgg_list_entities_atributos($options,'elgg_get_entities_from_metadata');
}
