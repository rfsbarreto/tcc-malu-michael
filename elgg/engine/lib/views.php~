...
/**
* Fun\E7\E3o criada Michael e Malu
* Criado em 01/04/2013
* Utilizado para pegar o destino e origem de uma rota
*/

function elgg_view_entity_list_rota($entities, $vars = array(), $offset = 0, $limit = 10, $full_view = true,
$list_type_toggle = true, $pagination = true)
{
	if (!is_int($offset)) {
		$offset = (int)get_input('offset', 0);
	...
	if ($vars['list_type'] != 'list') {
		...
		return elgg_view('page/components/list_rotaSearch', $vars);
	}
}
